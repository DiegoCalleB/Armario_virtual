...
8. Su caja delimitadora (bounding box) en coordenadas decimales normalizadas de 0.0 a 1.0 (donde box_ymin es el borde superior como float (ej: 0.15), box_xmin el borde izquierdo (ej: 0.25), box_ymax el borde inferior (ej: 0.55) y box_xmax el borde derecho (ej: 0.75) de la prenda en la imagen).
